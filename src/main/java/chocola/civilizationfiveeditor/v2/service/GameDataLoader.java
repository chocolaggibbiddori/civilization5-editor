...
public class GameDataLoader {
    ...
    private static List<Path> defaultPathList() {
        return List.of(
                ...
                EXPANSION2_CIVILIZATION_TEXT_FILE_PATH,
                EXPANSION2_TRAIT_TEXT_FILE_PATH,
                EXPANSION2_INHERITED_TRAIT_TEXT_FILE_PATH,
                EXPANSION2_LEADER_TEXT_FILE_PATH,
                EXPANSION2_CIVILOPEDIA_TEXT_FILE_PATH,
                EXPANSION2_JON_INHERITED_TEXT_FILE_PATH,
                EXPANSION2_UNIT_TEXT_FILE_PATH,
                EXPANSION2_OBJECT_TEXT_FILE_PATH,
                EXPANSION2_BUILDING_TEXT_FILE_PATH,
                EXPANSION2_BASIC_CIVILIZATION_FILE_PATH,
                EXPANSION2_CIVILIZATION_FILE_PATH,
                EXPANSION2_BASIC_TRAIT_FILE_PATH,
                EXPANSION2_TRAIT_FILE_PATH,
                EXPANSION2_DEFAULT_LEADER_PATH,
                EXPANSION2_BASIC_UNIT_FILE_PATH,
