...
public class PathUtils {
    ...
    public static final Path EXPANSION_TRAIT_TEXT_FILE_PATH = EXPANSION_DEFAULT_TEXT_PATH.resolve("CIV5GameTextInfos_Jon_Expansion.xml");
    ...
    public static final Path EXPANSION_DEFAULT_TERRAIN_PATH = EXPANSION_GAME_PATH.resolve("Terrain");
    public static final Path EXPANSION_IMPROVEMENT_FILE_PATH = EXPANSION_DEFAULT_TERRAIN_PATH.resolve("CIV5Improvements_Expansion.xml");
    ...
    public static final Path EXPANSION2_CIVILIZATION_TEXT_FILE_PATH = EXPANSION2_DEFAULT_TEXT_PATH.resolve("CIV5GameTextInfos_Civilizations_Expansion2.xml");
    ...
    public static final Path EXPANSION2_LEADER_TEXT_FILE_PATH = EXPANSION2_DEFAULT_TEXT_PATH.resolve("CIV5GameTextInfos_Leaders_Expansion2.xml");
    ...
    public static final Path EXPANSION2_UNIT_TEXT_FILE_PATH = EXPANSION2_DEFAULT_TEXT_PATH.resolve("CIV5GameTextInfos_Units_Expansion2.xml");
    public static final Path EXPANSION2_INHERITED_UNIT_TEXT_FILE_PATH = EXPANSION2_DEFAULT_TEXT_PATH.resolve("CIV5GameTextInfos_Units_Inherited_Expansion2.xml");
    public static final Path EXPANSION2_CIVILOPEDIA_TEXT_FILE_PATH = EXPANSION2_DEFAULT_TEXT_PATH.resolve("CIV5GameTextInfos_Civilopedia_Expansion2.xml");
    ...
    public static final Path EXPANSION2_BASIC_CIVILIZATION_FILE_PATH = EXPANSION2_DEFAULT_CIVILIZATION_PATH.resolve("CIV5Civilizations.xml");
    public static final Path EXPANSION2_CIVILIZATION_FILE_PATH = EXPANSION2_DEFAULT_CIVILIZATION_PATH.resolve("CIV5Civilizations_Expansion2.xml");
    public static final Path EXPANSION2_BASIC_TRAIT_FILE_PATH = EXPANSION2_DEFAULT_CIVILIZATION_PATH.resolve("CIV5Traits.xml");
    public static final Path EXPANSION2_TRAIT_FILE_PATH = EXPANSION2_DEFAULT_CIVILIZATION_PATH.resolve("CIV5Traits_Expansion2.xml");

    public static final Path EXPANSION2_DEFAULT_LEADER_PATH = EXPANSION2_GAME_PATH.resolve("Leaders");

    public static final Path EXPANSION2_DEFAULT_UNIT_PATH = EXPANSION2_GAME_PATH.resolve("Units");
    public static final Path EXPANSION2_BASIC_UNIT_FILE_PATH = EXPANSION2_DEFAULT_UNIT_PATH.resolve("CIV5Units.xml");
    public static final Path EXPANSION2_UNIT_FILE_PATH = EXPANSION2_DEFAULT_UNIT_PATH.resolve("CIV5Units_Expansion2.xml");
